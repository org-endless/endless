 ...
 */
@Slf4j
@Import({MongoTimerJobRepository.class})
public class MongoTimerJobDataManager extends AbstractMongoDataManager<TimerJobEntity>
        implements TimerJobDataManager {

    public static final String COLLECTION_TIMER_JOB = "ACT_RU_TIMER_JOB";

    public MongoTimerJobDataManager(MongoOperations operations) {
        super(operations);
    }

    @Override
    public String getCollection() {
        return COLLECTION_TIMER_JOB;
    }

    @Override
    public Class<TimerJobEntity> getEntityClass() {

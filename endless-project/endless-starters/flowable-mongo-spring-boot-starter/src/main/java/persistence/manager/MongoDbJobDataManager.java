 ...
 * @author Joram Barrez
 */
public class MongoDbJobDataManager extends AbstractMongoDbDataManager<JobEntity>
    ...
    public List<JobEntity> findJobsToExecute(List<String> enabledCategories, Page page) {
        ...
        if (jobServiceConfiguration.getJobExecutionScope() == null) {
            ...
            filter =
                    Filters.and(
                            Filters.eq("scopeType", jobServiceConfiguration.getJobExecutionScope()),
    ...
    public List<JobEntity> findExpiredJobs(List<String> enabledCategories, Page page) {
        ...
        Date maxTimeout =
                new Date(
                        now.getTime() - jobServiceConfiguration.getAsyncExecutorResetExpiredJobsMaxTimeout());
        ...
        filter =
                Filters.and(
                        ...
                        Filters.or(
                                ...
                                Filters.and(
                                        Filters.eq("lockExpirationTime", null), Filters.lt("createTime", maxTimeout))));

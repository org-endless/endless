...
import persistence.entity.MongoDbProcessDefinitionEntityImpl;
 ...
 * @author Joram Barrez
 */
public class MongoDbProcessDefinitionDataManager
        extends AbstractMongoDbDataManager<ProcessDefinitionEntity>
        implements ProcessDefinitionDataManager {

    public static final String COLLECTION_PROCESS_DEFINITIONS = "processDefinitions";

    public MongoDbProcessDefinitionDataManager(
    ...
    public BasicDBObject createUpdateObject(Entity entity) {
        MongoDbProcessDefinitionEntityImpl processDefinitionEntity =
                (MongoDbProcessDefinitionEntityImpl) entity;
        BasicDBObject updateObject = null;
        updateObject =
                setUpdateProperty(
                        processDefinitionEntity, "latest", processDefinitionEntity.isLatest(), updateObject);
        updateObject =
                setUpdateProperty(
    ...
    public void insert(ProcessDefinitionEntity entity) {
        MongoDbProcessDefinitionEntityImpl latestProcessDefinitionEntity =
    ...
    public ProcessDefinitionEntity findLatestProcessDefinitionByKey(String processDefinitionKey) {
        ...
        return getMongoDbSession()
                .findOne(
                        COLLECTION_PROCESS_DEFINITIONS,
                        Filters.and(Filters.eq("key", processDefinitionKey), Filters.eq("latest", true)));
    }
    ...
    @Override
    public ProcessDefinitionEntity findLatestDerivedProcessDefinitionByKey(
            String processDefinitionKey) {
        throw new UnsupportedOperationException();
    }

    @Override
    public ProcessDefinitionEntity findLatestDerivedProcessDefinitionByKeyAndTenantId(
            String processDefinitionKey, String tenantId) {
        throw new UnsupportedOperationException();
    }
    ...
    public void deleteProcessDefinitionsByDeploymentId(String deploymentId) {
        getMongoDbSession()
                .bulkDelete(COLLECTION_PROCESS_DEFINITIONS, Filters.eq("deploymentId", deploymentId));
    }
    ...
    public List<ProcessDefinition> findProcessDefinitionsByQueryCriteria(
        ...
        return getMongoDbSession()
                .find(COLLECTION_PROCESS_DEFINITIONS, createFilter(processDefinitionQuery));
    }
    ...
    public long findProcessDefinitionCountByQueryCriteria(
            ProcessDefinitionQueryImpl processDefinitionQuery) {
        return getMongoDbSession()
                .count(COLLECTION_PROCESS_DEFINITIONS, createFilter(processDefinitionQuery));
    }
    ...
    @Override
    public ProcessDefinitionEntity findProcessDefinitionByParentDeploymentAndKey(
            String parentDeploymentId, String processDefinitionKey) {
        throw new UnsupportedOperationException();
    }

    @Override
    public ProcessDefinitionEntity findProcessDefinitionByParentDeploymentAndKeyAndTenantId(
            String parentDeploymentId, String processDefinitionKey, String tenantId) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public void updateProcessDefinitionVersionForProcessDefinitionId(
            String processDefinitionId, int version) {
        throw new UnsupportedOperationException();
    }
}

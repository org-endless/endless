 ...
 * @author Joram Barrez
 */
public class MongoDbExternalWorkerJobDataManager
        extends AbstractMongoDbDataManager<ExternalWorkerJobEntity>
        implements ExternalWorkerJobDataManager {

    public static final String COLLECTION_EXTERNAL_WORKER_JOBS = "externalWorkerJobs";

    public MongoDbExternalWorkerJobDataManager() {
    ...
    @Override
    public List<ExternalWorkerJobEntity> findExternalJobsToExecute(
            ExternalWorkerJobAcquireBuilderImpl builder, int numberOfJobs) {
        throw new UnsupportedOperationException();
    }

    @Override
    public List<ExternalWorkerJobEntity> findJobsByScopeIdAndSubScopeId(
            String scopeId, String subScopeId) {
        throw new UnsupportedOperationException();
    }

    @Override
    public List<ExternalWorkerJobEntity> findJobsToExecute(
            List<String> enabledCategories, Page page) {
        throw new UnsupportedOperationException();
    }

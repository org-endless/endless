 ...
 * @author Joram Barrez
 */
public class MongoDbTaskDataManager extends AbstractMongoDbDataManager<TaskEntity>
        implements TaskDataManager {

    public static final String COLLECTION_TASKS = "tasks";

    public MongoDbTaskDataManager() {
    ...
    public BasicDBObject createUpdateObject(Entity entity) {
        ...
        updateObject =
                setUpdateProperty(taskEntity, "assignee", taskEntity.getAssignee(), updateObject);
    ...
    public List<Task> findTasksByQueryCriteria(TaskQueryImpl taskQuery) {
        return getMongoDbSession()
                .find(COLLECTION_TASKS, createFilter(taskQuery), createSort(taskQuery));
    }

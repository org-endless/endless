...
public class ThreadPoolProperties {
     ...
     */
    public final static Integer CPUS = Runtime.getRuntime().availableProcessors();

    public final static Integer DEFAULT_THREAD_CORE_SIZE = CPUS * 2;

    public final static Integer DEFAULT_THREAD_MAX_SIZE = DEFAULT_THREAD_CORE_SIZE * 2;

    public final static Integer DEFAULT_THREAD_QUEUE_SIZE = DEFAULT_THREAD_MAX_SIZE * 2;

    public final static String DEFAULT_THREAD_NAME_PREFIX = "Async-Thread-Pool-";

    public final static Integer DEFAULT_KEEP_ALIVE_SECONDS = 60;

    public final static Boolean DEFAULT_ALLOW_CORE_THREAD_TIME_OUT = false;

    public final static Boolean DEFAULT_WAIT_FOR_TASKS_TO_COMPLETE_ON_SHUTDOWN = false;

    public final static Integer DEFAULT_AWAIT_TERMINATION_SECONDS = 10;

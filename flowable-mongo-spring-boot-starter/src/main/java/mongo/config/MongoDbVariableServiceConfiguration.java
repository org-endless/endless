...
import mongo.persistence.manager.MongoDbHistoricVariableInstanceDataManager;
import mongo.persistence.manager.MongoDbVariableInstanceDataManager;
...
public class MongoDbVariableServiceConfiguration extends VariableServiceConfiguration {
    ...
    public void initDataManagers() {
        ...
        this.historicVariableInstanceDataManager = new MongoDbHistoricVariableInstanceDataManager();
    }
}

 ...
 */
public class HistoricProcessInstanceEntityMapper
        extends AbstractEntityToDocumentMapper<HistoricProcessInstanceEntityImpl> {
    ...
    public HistoricProcessInstanceEntityImpl fromDocument(Document document) {
        ...
        historicProcessInstanceEntity.setSuperProcessInstanceId(
                document.getString("superProccessInstanceId"));
    ...
    public Document toDocument(HistoricProcessInstanceEntityImpl historicProcessInstanceEntity) {
        ...
        appendIfNotNull(
                historicProcessInstanceDocument, "revision", historicProcessInstanceEntity.getRevision());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "processInstanceId",
                historicProcessInstanceEntity.getProcessInstanceId());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "businessKey",
                historicProcessInstanceEntity.getBusinessKey());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "processDefinitionId",
        ...
        appendIfNotNull(
                historicProcessInstanceDocument,
                "callbackId",
                historicProcessInstanceEntity.getCallbackId());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "callbackType",
                historicProcessInstanceEntity.getCallbackType());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "deleteReason",
                historicProcessInstanceEntity.getDeleteReason());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "durationInMillis",
                historicProcessInstanceEntity.getDurationInMillis());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "endActivityId",
                historicProcessInstanceEntity.getEndActivityId());
        appendIfNotNull(
                historicProcessInstanceDocument, "endTime", historicProcessInstanceEntity.getEndTime());
        appendIfNotNull(
                historicProcessInstanceDocument, "name", historicProcessInstanceEntity.getName());
        appendIfNotNull(
                historicProcessInstanceDocument, "revision", historicProcessInstanceEntity.getRevision());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "startActivityId",
                historicProcessInstanceEntity.getStartActivityId());
        appendIfNotNull(
                historicProcessInstanceDocument, "startTime", historicProcessInstanceEntity.getStartTime());
        appendIfNotNull(
                historicProcessInstanceDocument,
                "startUserId",
        ...
        appendIfNotNull(
                historicProcessInstanceDocument,
                "superProccessInstanceId",
                historicProcessInstanceEntity.getSuperProcessInstanceId());
        appendIfNotNull(
                historicProcessInstanceDocument, "tenantId", historicProcessInstanceEntity.getTenantId());

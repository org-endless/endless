 ...
 * @author Joram Barrez
 */
public class HistoricVariableInstanceEntityMapper
        extends AbstractEntityToDocumentMapper<HistoricVariableInstanceEntityImpl> {
    ...
    public HistoricVariableInstanceEntityImpl fromDocument(Document document) {
        ...
        variableEntity.setVariableType(

...
import mongo.persistence.EntityToDocumentMapper;
 ...
 * @author Joram Barrez
 */
public abstract class AbstractEntityToDocumentMapper<T extends Entity>
        implements EntityToDocumentMapper<T> {

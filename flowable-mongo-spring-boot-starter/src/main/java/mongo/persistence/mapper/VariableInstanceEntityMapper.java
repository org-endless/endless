 ...
 * @author Joram Barrez
 */
public class VariableInstanceEntityMapper
        extends AbstractEntityToDocumentMapper<VariableInstanceEntityImpl> {
    ...
    public Document toDocument(VariableInstanceEntityImpl variableEntity) {
        ...
        appendIfNotNull(
                variableDocument, "processDefinitionId", variableEntity.getProcessDefinitionId());

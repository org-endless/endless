...
public class ProcessDefinitionEntityMapper
        extends AbstractEntityToDocumentMapper<MongoDbProcessDefinitionEntityImpl> {
    ...
    public MongoDbProcessDefinitionEntityImpl fromDocument(Document document) {
        MongoDbProcessDefinitionEntityImpl processDefinitionEntity =
                new MongoDbProcessDefinitionEntityImpl();
        ...
        processDefinitionEntity.setGraphicalNotationDefined(
                document.getBoolean("isGraphicalNotationDefined", false));
    ...
    public Document toDocument(MongoDbProcessDefinitionEntityImpl processDefinitionEntity) {
        ...
        appendIfNotNull(
                processDefinitionDocument, "description", processDefinitionEntity.getDescription());
        ...
        appendIfNotNull(
                processDefinitionDocument, "deploymentId", processDefinitionEntity.getDeploymentId());
        appendIfNotNull(
                processDefinitionDocument, "resourceName", processDefinitionEntity.getResourceName());
        appendIfNotNull(processDefinitionDocument, "tenantId", processDefinitionEntity.getTenantId());
        appendIfNotNull(
                processDefinitionDocument, "historyLevel", processDefinitionEntity.getHistoryLevel());
        appendIfNotNull(
        ...
        appendIfNotNull(
                processDefinitionDocument, "hasStartFormKey", processDefinitionEntity.getHasStartFormKey());
        appendIfNotNull(
                processDefinitionDocument, "suspensionState", processDefinitionEntity.getSuspensionState());
        appendIfNotNull(
                processDefinitionDocument, "derivedFrom", processDefinitionEntity.getDerivedFrom());
        appendIfNotNull(
                processDefinitionDocument, "derivedFromRoot", processDefinitionEntity.getDerivedFromRoot());
        appendIfNotNull(
                processDefinitionDocument, "derivedVersion", processDefinitionEntity.getDerivedVersion());
        appendIfNotNull(
                processDefinitionDocument, "engineVersion", processDefinitionEntity.getEngineVersion());

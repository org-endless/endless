 ...
 * @author Joram Barrez
 */
public class IdentityLinkEntityMapper
        extends AbstractEntityToDocumentMapper<IdentityLinkEntityImpl> {
    ...
    public Document toDocument(IdentityLinkEntityImpl identityLinkEntity) {
        ...
        appendIfNotNull(
                identityLinkDocument, "processInstanceId", identityLinkEntity.getProcessInstanceId());
        appendIfNotNull(
                identityLinkDocument, "processDefinitionId", identityLinkEntity.getProcessDefinitionId());
        ...
        appendIfNotNull(
                identityLinkDocument, "scopeDefinitionId", identityLinkEntity.getScopeDefinitionId());

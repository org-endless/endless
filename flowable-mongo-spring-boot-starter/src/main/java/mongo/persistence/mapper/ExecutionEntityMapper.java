...
public class ExecutionEntityMapper extends AbstractEntityToDocumentMapper<ExecutionEntityImpl> {
    ...
    public Document toDocument(ExecutionEntityImpl executionEntity) {
        ...
        appendIfNotNull(
                executionDocument, "processDefinitionId", executionEntity.getProcessDefinitionId());
        ...
        appendIfNotNull(
                executionDocument, "isMultiInstanceRoot", executionEntity.isMultiInstanceRoot());
        ...
        appendIfNotNull(
                executionDocument, "rootProcessInstanceId", executionEntity.getRootProcessInstanceId());
        ...
        appendIfNotNull(
                executionDocument, "eventSubscriptionCount", executionEntity.getEventSubscriptionCount());
        ...
        appendIfNotNull(
                executionDocument, "deadLetterJobCount", executionEntity.getDeadLetterJobCount());

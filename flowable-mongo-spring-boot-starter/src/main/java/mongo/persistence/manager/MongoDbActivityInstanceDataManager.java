...
public class MongoDbActivityInstanceDataManager
        extends AbstractMongoDbDataManager<ActivityInstanceEntity>
    ...
    protected CachedEntityMatcher<ActivityInstanceEntity> activityInstanceMatcher =
            new ActivityInstanceMatcher();

    public MongoDbActivityInstanceDataManager(
    ...
    public BasicDBObject createUpdateObject(Entity entity) {
        ...
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity, "endTime", activityInstanceEntity.getEndTime(), updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity,
                        "transactionOrder",
                        activityInstanceEntity.getTransactionOrder(),
                        updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity,
                        "durationInMillis",
                        activityInstanceEntity.getDurationInMillis(),
                        updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity,
                        "deleteReason",
                        activityInstanceEntity.getDeleteReason(),
                        updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity,
                        "executionId",
                        activityInstanceEntity.getExecutionId(),
                        updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity, "taskId", activityInstanceEntity.getTaskId(), updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity, "assignee", activityInstanceEntity.getAssignee(), updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity,
                        "calledProcessInstanceId",
                        activityInstanceEntity.getCalledProcessInstanceId(),
                        updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity,
                        "activityId",
                        activityInstanceEntity.getActivityId(),
                        updateObject);
        updateObject =
                setUpdateProperty(
                        activityInstanceEntity,
                        "activityName",
                        activityInstanceEntity.getActivityName(),
                        updateObject);
        return updateObject;
    }

    @Override
    public List<ActivityInstanceEntity> findUnfinishedActivityInstancesByExecutionAndActivityId(
            String executionId, String activityId) {
        Bson filter =
                Filters.and(Filters.eq("executionId", executionId), Filters.eq("activityId", activityId));
    ...
    @Override
    public List<ActivityInstanceEntity> findActivityInstancesByExecutionIdAndActivityId(
            String executionId, String activityId) {
    ...
    @Override
    public List<ActivityInstanceEntity> findActivityInstancesByProcessInstanceId(
            String processInstanceId, boolean includeDeleted) {
    ...
    public void deleteActivityInstancesByProcessInstanceId(String processInstanceId) {
        ...
        List<ActivityInstanceEntity> activityInstancesByProcessInstanceId =
                findActivityInstancesByProcessInstanceId(processInstanceId, false);
    ...
    @Override
    public long findActivityInstanceCountByQueryCriteria(
            ActivityInstanceQueryImpl activityInstanceQuery) {
        throw new UnsupportedOperationException();
    }

    @Override
    public List<ActivityInstance> findActivityInstancesByQueryCriteria(
            ActivityInstanceQueryImpl activityInstanceQuery) {
        throw new UnsupportedOperationException();
    }

    @Override
    public List<ActivityInstance> findActivityInstancesByNativeQuery(

 ...
 * @author Joram Barrez
 */
public class MongoDbProcessDefinitionInfoDataManager
        extends AbstractMongoDbDataManager<ProcessDefinitionInfoEntity>
    ...
    public MongoDbProcessDefinitionInfoDataManager(

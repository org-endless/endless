 ...
 * @author Joram Barrez
 */
public class MongoDbVariableInstanceDataManager
        extends AbstractMongoDbDataManager<VariableInstanceEntity>
    ...
    public MongoDbVariableInstanceDataManager() {
    ...
    public BasicDBObject createUpdateObject(Entity entity) {
        ...
        updateObject =
                setUpdateProperty(variableEntity, "textValue", variableEntity.getTextValue(), updateObject);
        updateObject =
                setUpdateProperty(
                        variableEntity, "textValue2", variableEntity.getTextValue2(), updateObject);
        updateObject =
                setUpdateProperty(
                        variableEntity, "doubleValue", variableEntity.getDoubleValue(), updateObject);
        updateObject =
                setUpdateProperty(variableEntity, "longValue", variableEntity.getLongValue(), updateObject);
        updateObject =
                setUpdateProperty(variableEntity, "typeName", variableEntity.getTypeName(), updateObject);
        return updateObject;
    }

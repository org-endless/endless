...
public class Decimal {
  ...
  public static Decimal128 format128(Object decimal) {
    ...
    return new Decimal128(
        new BigDecimal(String.valueOf(decimal)).setScale(2, RoundingMode.HALF_EVEN));
  }
  ...
  public static BigDecimal median(List<BigDecimal> decimalList) {
    ...
    if (size % 2 == 0) {
      median =
          Decimal.divide(
              Decimal.add(decimalList.get(size / 2), decimalList.get(size / 2 - 1)),
              Decimal.format5Bit(2));
    } else {

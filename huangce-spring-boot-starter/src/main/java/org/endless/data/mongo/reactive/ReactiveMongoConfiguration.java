package org.endless.data.mongo.reactive;
...
public class ReactiveMongoConfiguration {
    ...
    //         @Qualifier("mongoClientProperties") CustomMongoClientProperties clientProperties) {
    //     return new CustomMongoClientSettingsBuilderCustomizer(clientProperties);
    // }
    //
    // public @Bean CustomMongoClientProperties mongoClientProperties() {
    //     return new CustomMongoClientProperties();
    // }
}
